 ...
 * 
 * 抖音云函数HTTP触发器调用格式：
 * POST https://{envId}.api.toutiao.com/api/function/{functionName}
 ...
 * @param data - 参数
 */
function callFunction(functionName: string, action: string, data: Record<string, any> = {}) {
...
export const userApi = {
  /** 获取用户列表 */
  getList: (params: { page: number; pageSize: number; userType?: string; keyword?: string }) =>
